                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control"
                                       id="othername" name="othername" value="">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div v-if="form.gender ==='Female'" class="form-group row">
                            <label class="col-sm-4 col-form-label">Specify</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control"
                                       id="specify" name="specify" value="">
                            </div>
                        </div>
<!--                        <div class="form-group row">-->
